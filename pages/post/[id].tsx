          ...
          <div className='post__body'>
            <div className='post__main'>
              ...
              <div className='post__text'>
                Я брать машина на сутки. Все класс. Парк хороший. Авто хороший.
                Звонил им, взял машина, ездил на машина 10 часов все было
                хорошо. Машина не ломаться, руль крутиться, коляса
                поворачиваться. Потом яма была, в яму упала, я жив. Права теперь
                нет, автопарк сказал, что машина должен вернуть, я машина
